...
import {{project.projectPackage}}.config.Constants;
import com.codahale.metrics.annotation.Timed;
import {{project.projectPackage}}.domain.User;
...
import {{project.projectPackage}}.web.rest.util.HeaderUtil;<% if (databaseType == 'sql' || databaseType == 'mongodb') { %>
import {{project.projectPackage}}.web.rest.util.PaginationUtil;<% } %>
