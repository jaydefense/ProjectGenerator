package {{project.projectPackage}}.web.websocket;

import {{project.projectPackage}}.security.SecurityUtils;
import {{project.projectPackage}}.web.websocket.dto.ActivityDTO;
...
import static {{project.projectPackage}}.config.WebsocketConfiguration.IP_ADDRESS;
