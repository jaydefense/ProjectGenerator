...
import {{project.projectPackage}}.config.oauth2.MongoDBApprovalStore;
import {{project.projectPackage}}.config.oauth2.MongoDBAuthorizationCodeServices;
import {{project.projectPackage}}.config.oauth2.MongoDBClientDetailsService;
import {{project.projectPackage}}.config.oauth2.MongoDBTokenStore;
import {{project.projectPackage}}.repository.*;<% } %>
import {{project.projectPackage}}.security.AjaxLogoutSuccessHandler;
import {{project.projectPackage}}.security.AuthoritiesConstants;
import {{project.projectPackage}}.security.Http401UnauthorizedEntryPoint;
