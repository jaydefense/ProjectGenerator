package {{project.projectPackage}}.service;
<% if (databaseType == 'sql' || databaseType == 'mongodb') { %>
import {{project.projectPackage}}.domain.Authority;<% } %>
import {{project.projectPackage}}.domain.User;<% if (databaseType == 'sql' || databaseType == 'mongodb') { %>
import {{project.projectPackage}}.repository.AuthorityRepository;<% if (authenticationType == 'session') { %>
import {{project.projectPackage}}.repository.PersistentTokenRepository;<% } %><% } %>
import {{project.projectPackage}}.repository.UserRepository;<% if (searchEngine == 'elasticsearch') { %>
import {{project.projectPackage}}.repository.search.UserSearchRepository;<% } %>
import {{project.projectPackage}}.security.AuthoritiesConstants;
import {{project.projectPackage}}.security.SecurityUtils;
import {{project.projectPackage}}.service.util.RandomUtil;
import {{project.projectPackage}}.web.rest.vm.ManagedUserVM;
